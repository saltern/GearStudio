...
func cell_ensure_selected_undo(cell: int) -> void:
	undo_redo.add_do_method(cell_ensure_selected.bind(cell))
	undo_redo.add_undo_method(cell_ensure_selected.bind(cell))
